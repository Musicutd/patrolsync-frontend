(function(){
  ...
  const groups=[
    ...
    ['Field Operations',[['patrol_routes.html','⌖','Patrol Routes'],['patrol_runs.html','↻','Patrol Runs'],['checkpoint_manager.html','▦','Checkpoint Manager'],['patrol_alerts.html','△','Patrol Alerts'],['patrol_evidence.html','◇','Patrol Evidence'],['trustproof.html','◆','TrustProof'],['checkpoint_requirements.html','✓','Checkpoint Instructions'],['handover_management.html','↦','Shift Handovers'],['lone_worker.html','◉','Lone Worker'],['asset_management.html','▣','Equipment & Assets'],['quality_inspections.html','✓','Quality Inspections']]],
