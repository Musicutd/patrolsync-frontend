(function () {
  ...
  const groups = [
    ...
    ['Business', [['proofscore.html','◆','ProofScore Assurance'],['assurance_trends.html','⌁','ProofScore Trends'],['assurance_actions.html','✓','Improvement Plans'],['assurance_readiness.html','✓','Assurance Readiness'],['predictive_assurance.html','◔','Predictive Assurance'],['service_credit_autopilot.html','€','Service Credit Autopilot'],['commercial_readiness.html','✓','Commercial Readiness'],['client_retention_radar.html','◎','Client Retention Radar'],['tender_builder.html','▤','Tender & Proposal Builder'],['service_contracts.html','▤','Contracts & SLAs'],['sla_dashboard.html','◷','Live SLA'],['client_reports.html','▥','Client Reports'],['service_tickets.html','◇','Service Tickets'],['contract_renewals.html','↻','Contract Renewals'],['invoices.html','€','Billing & Invoices'],['analytics.html','⌁','Analytics'],['email_deliveries.html','✉','Email Deliveries']]],
