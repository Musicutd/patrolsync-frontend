(function(){
  ...
  const groups=[
    ['Command',[['dashboard.html','▦','Overview'],['live_map.html','⌖','Live Guard Map'],['attendance.html','◷','Attendance'],['dispatch_center.html','⌁','Dispatch Center'],['sos_monitor.html','△','SOS Monitor'],['incident_management.html','△','Incident Cases'],['notification_center.html','●','Notifications']]],
    ...
    ['Field Operations',[['patrol_routes.html','⌖','Patrol Routes'],['patrol_runs.html','↻','Patrol Runs'],['checkpoint_manager.html','▦','Checkpoint Manager'],['qr_print.html','▧','QR Code Printing'],['patrol_alerts.html','△','Patrol Alerts'],['patrol_evidence.html','◇','Patrol Evidence'],['trustproof.html','◆','TrustProof'],['checkpoint_requirements.html','✓','Checkpoint Instructions'],['handover_management.html','↦','Shift Handovers'],['lone_worker.html','◉','Lone Worker'],['asset_management.html','▣','Equipment & Assets'],['quality_inspections.html','✓','Quality Inspections']]],
